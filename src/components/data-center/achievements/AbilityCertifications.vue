    ...
    <div class="content-section">
      ...
      <div class="section-header">
        <div class="stats-overview">
          ...
          <div 
            class="stat-item clickable-tab" 
            :class="{ 'tab-active': selectedFilter === 'review-expert' }"
            @click="selectedFilter = 'review-expert'"
          >
            <span class="stat-label">评审专家：</span>
            <span class="stat-value">{{ getCountByType('review-expert') }}</span>
          </div>
          <div 
            class="stat-item clickable-tab" 
            :class="{ 'tab-active': selectedFilter === 'teaching-master' }"
            @click="selectedFilter = 'teaching-master'"
          >
            <span class="stat-label">教学名师：</span>
            <span class="stat-value">{{ getCountByType('teaching-master') }}</span>
          </div>
          <div 
            class="stat-item clickable-tab" 
            :class="{ 'tab-active': selectedFilter === 'dual-teacher' }"
            @click="selectedFilter = 'dual-teacher'"
          >
            <span class="stat-label">双师认证：</span>
            <span class="stat-value">{{ getCountByType('dual-teacher') }}</span>
          </div>
        </div>
          ...
          <div class="table-body">
            ...
            >
              ...
              <div class="col-type">
                ...
                >
                  {{ getCertificationTypeName(cert.type) }}
                </span>
              </div>
              <div class="col-cert">{{ cert.certificationDate }}</div>
          ...
          >
            ...
            <div class="card-content">
              ...
              <div class="info-row">
                ...
                <span class="value">{{ cert.certificationDate }}</span>
              </div>
              <div class="info-row">
      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          ...
          <div class="certification-info">
            <div class="info-item">
              <span class="label">认证编号：</span>
              <span class="value">{{ selectedCertification?.number }}</span>
            </div>
            <div class="info-item">
              <span class="label">认证机构：</span>
            ...
            <div class="info-item">
              ...
              <span class="value">
                ...
                >
                  {{ getCertificationTypeName(selectedCertification?.type) }}
                </span>
              </span>
            </div>
            <div class="info-item">
              <span class="label">认证时间：</span>
              <span class="value">{{ selectedCertification?.certificationDate }}</span>
            </div>
            <div class="info-item">
              <span class="label">有效时间：</span>
              <span class="value">{{ selectedCertification?.validUntil }}</span>
            </div>
            <div class="info-item">
              <span class="label">附件资料：</span>
              <div class="docs-list">
...
const getCountByType = (type) => {
  return certifications.value.filter(cert => cert.type === type).length
}
...
const certifications = ref([
  {
    ...
    image: '/pic/data.png',
    documents: [
      { name: '专家聘书.pdf', size: '1.2MB', uploadTime: '2024-01-10' },
      { name: '评审记录.docx', size: '856KB', uploadTime: '2024-01-12' }
    ]
  },
  {
    id: 2,
    ...
    image: '/pic/data.png',
    documents: [
      { name: '名师证书.pdf', size: '1.5MB', uploadTime: '2023-09-18' },
      { name: '教学成果报告.docx', size: '2.1MB', uploadTime: '2023-09-22' }
    ]
  },
  {
    id: 3,
    ...
    number: 'DT2023003',
    organization: '职业教育学会',
    certificationDate: '2022-12-10',
    validUntil: '2024-12-10',
    status: 'expired',
    type: 'dual-teacher',
    image: '/pic/data.png',
    documents: [
      { name: '双师证书.pdf', size: '1.8MB', uploadTime: '2022-12-08' }
    ]
  },
  {
    id: 4,
    ...
    documents: [
      { name: '国家级证书.pdf', size: '2.3MB', uploadTime: '2024-03-01' },
      { name: '教学案例集.pdf', size: '3.5MB', uploadTime: '2024-03-10' },
      { name: '获奖证明.jpg', size: '1.1MB', uploadTime: '2024-03-15' }
    ]
  },
  {
    id: 5,
    ...
    image: '/pic/data.png',
    documents: [
      { name: '行业专家证.pdf', size: '945KB', uploadTime: '2024-02-18' }
    ]
  }
])
...
const getCertificationTypeName = (type) => {
  return certificationTypeMap[type] || '未知类型'
}

const getTypeBadgeClass = (type) => {
  const typeClassMap = {
    'review-expert': 'type-review',
    'teaching-master': 'type-teaching',
    'dual-teacher': 'type-dual'
  }
