<template>
  <div class="archive-list">
    ...
    <div v-else-if="filteredArchives.length === 0" class="empty-state">
      ...
      <p>暂无档案</p>
      <small>点击"创建档案"按钮开始创建您的档案</small>
    </div>
      ...
      <table class="archive-table">
        ...
        <tbody>
          ...
          >
            ...
            <td class="col-name">
              <div class="name-cell">
                <div class="name-icon" style="display: none;">
...
const archives = ref([
  {
    id: 1,
    name: '2024年度教学工作总结',
    description: '包含教学成果、学生评价、课程改进等内容',
    format: 'pdf',
    formatText: 'PDF',
    purpose: 'promotion',
    purposeText: '晋升',
  ...
  },
  {
    id: 3,
    name: '课程建设方案',
    description: '新课程开发计划、教学大纲、资源整合方案',
    format: 'pptx',
    formatText: 'PPT',
    purpose: 'other',
    purposeText: '其他',
...
const editArchive = (archive) => {
  console.log('编辑档案:', archive.name)
  // 这里可以打开编辑弹窗或跳转到编辑页面
}

const deleteArchive = (archive) => {
  if (confirm(`确定要删除档案"${archive.name}"吗？`)) {
