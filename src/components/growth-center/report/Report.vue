...
const analysisItems = ref([
  {
    title: '教学能力与效果',
    content: '张老师承担了繁重的教学任务，日常投入度很高，展现了高度的责任心。在其指导下，所带班级学生学业成绩稳定，通过率达到89%，这反映了其教学的基础扎实，能够保证学生掌握和理解知识。'
  },
  {
    title: '教学注重因材施教',
  ...
  {
    title: '技术应用与研究创新',
    content: '张老师在日常工作中积极运用各类AI功能工具，体现了在专业高度上的良好示范作用。在此基础上，建议张老师进一步探索在开发原创性工具、模型或教学方法方面的创新，同时，建议将AI应用方面的具体心得，通过培训、分享等形式向更广泛范围的教师进行传播，发挥更大的示范作用。'
  },
  {
    title: '课程研发与团队贡献',
