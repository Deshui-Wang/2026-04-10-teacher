...
const generateAIResponse = (userMessage) => {
  ...
  if (currentDraggedCourseware.value && userMessage.includes('课件描述')) {
    ...
    aiResponse = `📊 **作业与成绩管理**\n\n我可以协助您：\n\n✅ **作业设计**\n- 根据教学目标设计作业题\n- 分层设计不同难度的题目\n- 提供参考答案和评分标准\n\n📈 **成绩分析**\n- 统计班级整体表现\n- 分析知识点掌握情况\n- 识别学习困难学生\n\n💬 **反馈建议**\n- 生成个性化作业评语\n- 提供针对性改进建议\n- 制定辅导计划\n\n请告诉我您需要哪方面的具体帮助？`
  } else if (userMessage.includes('成长') || userMessage.includes('发展')) {
    aiResponse = `好的，已收到您关于个人成长发展的分析请求。正在为您生成专属报告...\n\n📊 **个人成长发展智能分析报告**\n\n**一、 综合评估**\n根据您的教学数据、科研成果和专业发展记录，系统综合评定您的成长轨迹呈现稳健上升趋势。您在 **教学创新** 和 **科研能力** 两个维度上表现尤为突出，展现了卓越的专业素养和发展潜力。\n\n**二、 核心能力雷达图**\n- **教学设计**：92% (优秀) - 课程设计系统性强，教学目标明确。\n- **科研创新**：95% (卓越) - 近期发表高水平论文，主持国家级项目。\n- **学生指导**：88% (良好) - 指导学生竞赛获奖，深受学生好评。\n- **技术应用**：93% (优秀) - 熟练运用多种智能工具，教学效率显著提升。\n- **同行交流**：85% (良好) - 积极参与学术会议和教研活动，影响力逐步扩大。\n\n**三、 发展亮点 ✨**\n1.  **教学创新成果显著**：您在《人工智能基础》课程中采用的项目式学习方法，学生满意度和学习效果评估均位列前10%。\n2.  **科研能力持续突破**：您主持的国家级项目“基于深度学习的智能教学辅助系统研究”进展顺利，阶段性成果已发表于核心期刊。\n3.  **智能工具应用广泛**：您在数字人、智能体和知识库等工具的使用和开发方面数据亮眼，体现了卓越的数字化教学能力。\n\n**四、 潜在发展机遇 🚀**\n1.  **跨学科融合**：建议您尝试将人工智能技术与其他人文社科领域结合，探索新的交叉学科研究方向。\n2.  **国际学术交流**：您的研究成果具备国际前沿水平，建议积极参与国际顶级学术会议，扩大学术影响力。\n3.  **教学成果转化**：考虑将您的优秀教学方法和课件转化为在线课程或教材，惠及更广泛的学习者。\n\n**五、 智能建议**\n- **建议1**：参加下个月在上海举办的“全球人工智能教育峰会”，拓展国际视野。\n- **建议2**：开设一门关于“AI伦理与教育应用”的新课程，填补校内课程空白。\n- **建议3**：申请“教学名师”培育计划，将您的教学经验系统化、理论化。\n\n希望这份报告对您有所帮助。如果您需要针对某个具体方面进行更深入的分析，请随时告诉我！`
  } else if (userMessage.includes('翻译')) {
    aiResponse = `🌐 **AI翻译助手**\n\n我支持多语言翻译服务：\n\n📖 **学术翻译**\n- 论文摘要翻译\n- 专业术语转换\n- 保持学术规范性\n\n📚 **教学材料翻译**\n- 课件内容翻译\n- 教材章节翻译\n- 双语对照制作\n\n✉️ **日常翻译**\n- 邮件翻译\n- 通知公告翻译\n- 对外交流材料\n\n请直接发送需要翻译的内容，并告诉我目标语言！`
  } else if (userMessage.includes('数字智能技能评价')) {
    aiResponse = `📊 **教师综合数字智能技能评估报告**\n\n您好！根据系统对您在**数字素养页面**的工具使用频率（平均217次/天）、**智能作品库**（AI PPT、AI视频等）及**成果数据**的深度挖掘，为您生成以下综合评价：\n\n### 1. 核心素养概览 🏆\n- **数字化适应力**：**95 (卓越)** - 您能极快地掌握并应用前沿AI工具，如数字人视频与智能体构建。\n- **数字产出效能**：**92 (优秀)** - 平均每天产出12-18份高质量智能素材，教学反馈评分均在4.5以上。\n- **智能驱动创新**：**88 (良好)** - 成功将AI生图与生成式分析应用到科研论文框架构建中。\n\n### 2. 技术栈覆盖度分析 🛠\n- **成熟应用区**：**AI PPT、知识库、AI智课**。您在这些领域的应用已实现教研全流程覆盖，能够利用知识库快速生成结构化教案。\n- **进阶应用区**：**数字人视频、工作流自动化**。您近期开始尝试使用D-ID/HeyGen类工具制作数字人课程，表现出极强的跨媒体叙事能力。\n- **探索应用区**：**多模态Agent构建**。建议未来加强在特定学科大模型微调和私有化智能体部署方面的探索。\n\n### 3. 数字成果亮点 ✨\n1. **高频互动闭环**：您利用“AI生图”制作的课件视觉质量提升显著，学生课堂参与度同比提升了**23%**。\n2. **教研提效**：通过“工作流”自动化整理竞赛资料，使原本需要3天的成果汇总缩短至**2小时**。\n3. **数字伦理先行**：在所有AI生成内容中展示了良好的溯源标注，数字伦理评分稳居全校前5%。\n\n### 4. 未来提升建议 🚀\n- **深化生成式科研**：尝试将“生成式分析”更深度地引入实验数据预处理环节，提升科研成果产出的科学性。\n- **构建个人数字品牌**：建议将您积累的高质量数字人视频系列化，打造个人专属的“数字化名师空间”。\n- **智能体协同**：学习如何通过API调用实现多智能体（Multi-Agent）协同，进一步自动化复杂的行政与教学任务。\n\n**总结**：您是一位典型的**“数字化领航型教师”**，已跨越了工具替代阶段，正进入**AI共生创新**的关键期。期待您在数字教育领域取得更多突破！`
  } else {
    // 通用智能回复
...
// 处理外部触发的 AI 动作
const handleExternalAIAction = (data) => {
  console.log('接收到外部 AI 触发指令:', data)
...
onMounted(() => {
  ...
  // 监听事件总线
  if (eventBus) {
    eventBus.on('triggerAIAction', handleExternalAIAction)
  }
})
...
onUnmounted(() => {
  ...
  if (eventBus) {
    eventBus.off('triggerAIAction', handleExternalAIAction)
  }
})
</script>
